...
export default {
    ...
    CardColors: 'Colores de las tarjetas',
		Table: 'Tabla',
    agGridTable: 'Tabla cuadriculada',
		Components: 'Componentes',
		Alert: 'Alertas',
		Avatar: 'Avatar',
		Badge: 'Placa',
    ...
    ButtonGroup: 'Boton grupal',
		...
		Upload: 'Subir',
		FormsAndTable: 'Formularios & Tablas',
    ...
    UserSettings: 'Configuraciones de usuario',
		...
		ChartsAndMaps: 'Graficos & Mapas',
		Charts: 'Graficos',
		ApexCharts: 'Apex Graficos',
		chartjs: 'chartjs',
		echarts: 'echarts',
		chartist: 'chartist',
    ...
    DatetimePicker: 'Datetime Picker',
		...
		ContextMenu: 'Contexto de menu',
    StarRatings: 'Calificación de estrellas',
    Autocomplete: 'Autocompletar',
    Tree: 'Arbol',
    // "Import/Export": 'Import/Export',
    Import: 'Importar',
    Export: 'Exportar',
    ExportSelected: "Exportar seleccionadors",
		Others: 'Otros',
		MenuLevels: 'Niveles menu',
		MenuLevel2p1: 'Nivel menu 2.1',
		MenuLevel2p2: 'Nivel menu 2.2',
		MenuLevel3p1: 'Nivel menu 3.1',
		MenuLevel3p2: 'Nivel menu 3.2',
